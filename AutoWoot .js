...
(function() {
    if (!requirejs.defined('c447a/b3359/e3636'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', true), false;

    define('ff0831/c960fa', ['jquery', 'underscore', 'c447a/b3359/e3636', 'c447a/b3359/acadc', 'c447a/c69af/cfe54', 'c447a/ffc0a/b2ea0', 'c447a/b2771/dedbb', 'c447a/d71b1/e13fb', 'c447a/adaf2/c6be5', 'c447a/fe69e/db338', 'c447a/fe69e/a4bbc', 'c447a/d71b1/f6dd2', 'lang/Lang', 'c447a/f6dd0/b3528/ff671', 'c447a/adaf2/e2d97', 'c447a/adaf2/a6ce3', 'ff0831/e4a458', 'c447a/f6dd0/b3528/acec6/be4a7', 'c447a/f6dd0/b3528/acec6/e4a3c', 'ff0831/b978ba', 'ff0831/ecb90b', 'ff0831/ac3e26', 'c447a/ffc0a/b832e', 'c447a/d71b1/c58eb', 'ff0831/cd4ccc/c52d43', 'ff0831/b8f89a', 'ff0831/ed26d7', 'ff0831/cd4ccc/e7144c'], function($, _, Class, Context, Chat, LocalStorage, Utils, Room, MCE, Socket, SIO, TUM, Lang, Audience, RJE, RSE, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, Database, PlaybackModel, dialogCommands, Slider, VolumeView, dialogColors) {
    ...
    define('ff0831/cd4ccc/bd6db0', ['underscore', 'c447a/ffc0a/b2ea0', 'ff0831/ecb90b', 'c447a/adaf2/a2909', 'c447a/adaf2/b848d', 'c447a/c69af/cfe54', 'c447a/d71b1/f6dd2', 'c447a/d71b1/e7836', 'c447a/d988a/acec6/e0837', 'c447a/b2771/dedbb', 'c447a/f6dd0/fde54/bde31', 'c447a/f6dd0/dc8d0/dfec8', 'lang/Lang'], function(_, LocalStorage, p3Lang, t, n, r, i, s, o, u, a, f, l) {
        var langauges,
            c = a.extend({
    ...
    define('ff0831/cd4ccc/e7144c', ['jquery', 'c447a/b3359/e3636', 'lang/Lang', 'c447a/b3359/acadc', 'ff0831/ecb90b'], function($, b, c, d, p3Lang) {
    ...
    define('ff0831/cd4ccc/f16435', ['jquery', 'c447a/f6dd0/fde54/bde31', 'lang/Lang', 'c447a/b3359/e3636', 'c447a/b3359/acadc', 'c447a/adaf2/d63bf', 'ff0831/ecb90b'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('ff0831/cd4ccc/c52d43', ['jquery', 'c447a/b3359/e3636', 'lang/Lang', 'ff0831/ecb90b', 'ff0831/ac3e26'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
            ...
            modCommands = [
                ...
                ['/whois all', 'commands.descriptions.whois', API.ROLE.COHOST],
                ['/banall', 'commands.descriptions.banall', API.ROLE.COHOST]
            ],
            a = b.extend({
                print: function() {
    ...
    define('ff0831/e4a458', ['jquery', 'c447a/b3359/e3636'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('ff0831/ac3e26', ['c447a/f6dd0/b3528/d0d28/d8eb3'], function(PopoutView) {
        ...
        return {
            isPlugCubedDeveloper: function(id) {
                ...
                return id == '51af4f7f3b79033963baebb9';
            },
            ...
            isPlugCubedVIP: function(id) {
                if (!id) id = API.getUser().id;
                return ['51af4f7f3b79033963baebb9', '5151c65596fba50b27ef2f34', '50aeb077877b9217e2fbff00', '50aeb020d6e4a94f774740a9'].indexOf(id) > -1;
            },
    ...
    define('ff0831/b978ba', ['jquery', 'c447a/f6dd0/b3528/acec6/b9570', 'ff0831/ac3e26'], function($, RoomUserListRow, p3Utils) {
    ...
    define('ff0831/ecb90b', ['jquery', 'c447a/b3359/e3636'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('ff0831/b8f89a', ['jquery', 'c447a/b3359/e3636'], function($, Class) {
        return Class.extend({
    ...
    define('ff0831/f0a227', ['jquery', 'c447a/b3359/e3636', 'ff0831/c960fa', 'c447a/ffc0a/b2ea0', 'c447a/f6dd0/fde54/bde31', 'ff0831/ecb90b', 'ff0831/ac3e26'], function($, Class, Model, LocalStorage, ADV, p3Lang, p3Utils) {
    ...
    */
    define('ff0831/ed26d7', ['jquery', 'underscore', 'c447a/f6dd0/b3528/d2a29/cd4e0', 'c447a/d71b1/c58eb', 'hbs!template/room/playback/Volume', 'c447a/b3359/acadc', 'ff0831/ecb90b'], function($, e, original, r, s, Context, p3Lang) {
